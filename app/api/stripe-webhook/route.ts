            ...
            <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 650px; margin: 0 auto; background: #ffffff;">
              ...
              <div style="padding: 40px 30px;">
                ...
                <div style="margin: 20px 0; padding: 15px; font-size: 11px; color: #64748b; line-height: 1.6; border-top: 1px solid #e2e8f0;">
                  ...
                  <p style="margin: 5px 0;"><strong>Airport Arrivals:</strong> 45 minutes of waiting time included from estimated landing time. After this, extra charges apply: Sedan 105€ + 10% VAT/hour, Minivan 120€ + 10% VAT/hour, Van/Luxury Sedan 150€ + 10% VAT/hour. If delay exceeds 3 hours from the estimated booked landing time, service must be rescheduled.</p>
                  <p style="margin: 5px 0;"><strong>Train Station Arrivals:</strong> 20 minutes of waiting time included from estimated arrival time. After this, extra charges apply: Sedan 105€ + 10% VAT/hour, Minivan 120€ + 10% VAT/hour, Van/Luxury Sedan 150€ + 10% VAT/hour. If delay exceeds 2 hours from the estimated booked landing time, service must be rescheduled.</p>
